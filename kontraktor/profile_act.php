...
// Update query
$sql = "UPDATE kontraktor_report SET nama = $1, username = $2 WHERE id = $3";

// Check if password is provided
if (!empty($password)) {
    $hashed_password = password_hash($password, PASSWORD_BCRYPT);
    $sql = "UPDATE kontraktor_report SET nama = $1, username = $2, password = $3 WHERE id = $4";
...
if ($result) {
    ...
    if ($file_path['size'] > 0) {
        ...
        $sql_file = "UPDATE kontraktor_report SET file_admin = $1 WHERE id = $2";
