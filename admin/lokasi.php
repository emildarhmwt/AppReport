    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="body-wrapper">
                                    ...
                                    <table class="table table-bordered text-nowrap mb-0 align-middle table-hover">
                                        <thead class="fs-4">
                                            <tr class="text-center">
                                                ...
                                                <th class="fs-3" style="width: 90%">Lokasi Kerja</th>
            ...
            function deleteMuatan(id) {
                console.log('Deleting lokasi kerja with ID:', id); // Debugging: Log the ID being deleted
                if (confirm('Apakah Anda yakin ingin menghapus lokasi kerja ini?')) {
                    fetch('deleteLokasi.php', {
                            method: 'DELETE',
                            body: JSON.stringify({
                                id: id
            ...
            function renderTable(data) {
                ...
                const sortedData = data.sort((a, b) => a.lokasi.localeCompare(b.lokasi));

                const filteredData = sortedData.filter(report =>
                    report.lokasi.toLowerCase().includes(searchInput.value.toLowerCase())
                );
            ...
            <tr class="text-center">
                ...
                <td>${report.lokasi}</td>
                <td>
                    <button onclick="window.location.href='editLokasi.php?id=${report.id}'" class="btn btn-primary btn-sm" title="Edit">
                        <i class="bi bi-pen"></i>
                    </button>
