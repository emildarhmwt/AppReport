...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $query = "SELECT * FROM alat WHERE id = $id"; // Adjust the query as needed
    $result = pg_query($conn, $query);
    $adminData = pg_fetch_assoc($result);

    // Check if admin data was found
    if (!$adminData) {
        echo "Giliran / group not found.";
        exit;
    }
} else {
    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-body">
                        <h5 class="judul fw-semibold">Form Edit Alat Gali / Muat</h5>
                        <form method="post" action="alat_update.php" enctype="multipart/form-data">
                            <div class="mb-3">
                                <label for="nama" class="sub-judul mb-2">Alat Gali / Muat :</label>
                                <input type="text" class="form-control text-white" id="alat" name="alat"
                                    value="<?php echo htmlspecialchars($adminData['alat']); ?>" required>
                            </div>
