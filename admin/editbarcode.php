...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $query = "SELECT * FROM barcode_pengawas WHERE id = $id"; // Adjust the query as needed
        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title fw-semibold mb-4">Form Edit Barcode Pengawas</h5>
                            <div class="card">
                                <div class="card-body">
                                    <form method="post" action="barcode_update.php" enctype="multipart/form-data">
                                        <div class="mb-3">
