...
$query = "SELECT * FROM barcode_pengawas";
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6 d-flex justify-content-end">
                                        <button type="button" class="btn btn-primary mx-3"
                                            ...
                                            onclick="window.location.href='tambahBarcodePengawas.php'"><i
                                    ...
                                    <table class="table table-bordered text-nowrap mb-0 align-middle table-hover">
                                        ...
                                        <tbody id="barcodeTableBody">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button
                                                        onclick="window.location.href='editbarcode.php?id=<?php echo $report['id']; ?>'"
                                                        class="btn btn-primary btn-sm" title="Edit">
                                                        <i class="bi bi-pen"></i>
                                                    </button>
                                                    <button onclick="deleteBarcode(<?php echo $report['id']; ?>)"
                ...
                displayedData.forEach((report, index) => {
                    const row = `<tr>
                        ...
                        <td>
                            ...
                            <button 
                                onclick="deleteBarcode(<?php echo $report['id']; ?>)"
                                class="btn btn-danger btn-sm" title="Hapus">
                                <i class="bi bi-trash3"></i>
                            </button>
                        </td>
