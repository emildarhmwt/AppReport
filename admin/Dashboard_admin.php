...
$sql_production = "SELECT COUNT(*) FROM production_report WHERE proses_pengawas = 'Rejected Pengawas'";
$sql_hourmeter = "SELECT COUNT(*) FROM hourmeter_report WHERE proses_pengawas = 'Rejected Pengawas'";

$rejected_production = pg_fetch_result(pg_query($conn, $sql_production), 0, 0);
$rejected_hourmeter = pg_fetch_result(pg_query($conn, $sql_hourmeter), 0, 0);
