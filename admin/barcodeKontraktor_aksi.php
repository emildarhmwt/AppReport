        ...
        if ($fileError === 0) {
            if ($fileSize < 5000000) { // Batasi ukuran file hingga 5MB
                ...
                if (move_uploaded_file($fileTmpName, $fileDestination)) {
                    ...
                    $query = "INSERT INTO barcode_kontraktor (nama, jabatan, nip, name, file_path, mime_type) VALUES ($1, $2, $3, $4, $5, $6)";
                    $result = pg_query_params($conn, $query, [$nama, $jabatan, $nip, $fileName, $fileDestination, $fileType]);

                    if ($result) {
                        // Redirect to barcode.php
                        echo "<script>console.log('Data berhasil disimpan dan gambar diunggah.'); window.location.href='barcode_kontraktor.php';</script>";
                    } else {
