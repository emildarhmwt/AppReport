...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $query = "SELECT * FROM timbunan WHERE id = $id"; // Adjust the query as needed
    $result = pg_query($conn, $query);
    $adminData = pg_fetch_assoc($result);

    // Check if admin data was found
    if (!$adminData) {
        echo "Timbunan not found.";
        exit;
    }
} else {
...
<body>
    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-body">
                        <h5 class="judul fw-semibold">Form Edit Timbunan</h5>
                        <form method="post" action="timbunan_update.php" enctype="multipart/form-data">
                            <div class="mb-3">
                                <label for="nama" class="sub-judul mb-2">Timbunan :</label>
                                <input type="text" class="form-control text-white" id="timbunan" name="timbunan"
                                    value="<?php echo htmlspecialchars($adminData['timbunan']); ?>" required>
                            </div>
    ...
    function goBack() {
        window.location.href = 'Timbunan.php';
    }
    </script>
