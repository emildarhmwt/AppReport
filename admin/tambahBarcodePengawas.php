    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-body">
                        <h5 class="judul fw-semibold">Form Barcode Pengawas</h5>
                        <form action="barcode_aksi.php" method="POST" enctype="multipart/form-data">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label for="shift" class="sub-judul mb-2">Jabatan : </label>
                                <input type="text" class="form-control text-white" name="jabatan" id="jabatan"
                                    placeholder="Input Data" required>
                            </div>
                            <div class="mb-3">
                                <label for="grup" class="sub-judul mb-2">NIP :</label>
                                <input type="text" class="form-control text-white" id="nip" name="nip"
                                    placeholder="Input Data" required>
                            </div>
                            <div class="mb-5">
                                <label for="formFile" class="sub-judul mb-2">Barcode</label>
                                <input class="form-control text-white" type="file" name="image" id="image"
                                    accept="image/png, image/jpeg">
                            </div>
                            <button type="submit" class="btn btn-primary"> Submit</button>
                            <button type="button" class="btn btn-danger mx-3"
                                onclick="window.location.href='barcode.php'"> Kembali</button>
                        </form>
                    </div>
                </div>
            </div>
