...
$query = "UPDATE production_report SET operation_report_id = $1, proses_pengawas = NULL, proses_kontraktor = NULL, alasan_reject = NULL, kontraktor = NULL, name_pengawas = NULL, file_pengawas = NULL, name_kontraktor = NULL, file_kontraktor = NULL WHERE id = $2";
