    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-body">
                        <h5 class="judul fw-semibold">Data Timbunan</h5>
                                    ...
                                    <table class="table table-bordered text-nowrap mb-0 align-middle table-hover">
                                        <thead class="fs-4">
                                            <tr class="text-center">
                                                ...
                                                <th class="fs-3" style="width: 45%">Timbunan</th>
            ...
            function deleteMuatan(id) {
                console.log('Deleting timbunan with ID:', id); // Debugging: Log the ID being deleted
                if (confirm('Apakah Anda yakin ingin menghapus timbunan ?')) {
                    fetch('deleteTimbunan.php', {
                            method: 'DELETE',
                            body: JSON.stringify({
                                id: id
            ...
            function renderTable(data) {
                ...
                const sortedData = data.sort((a, b) => a.timbunan.localeCompare(b.timbunan));

                const filteredData = sortedData.filter(report =>
                    report.timbunan.toLowerCase().includes(searchInput.value.toLowerCase())
                );
            ...
            <tr class="text-center">
                ...
                <td>
                    <button onclick="window.location.href='editTimbunan.php?id=${report.id}'" class="btn btn-primary btn-sm" title="Edit">
                        <i class="bi bi-pen"></i>
                    </button>
