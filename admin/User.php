    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-body">
                        <h5 class="judul fw-semibold">Data Pengawas</h5>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6 d-flex justify-content-end">
                                        <button type="button" class="btn btn-primary mx-3"
                                            onclick="window.location.href='TambahUser.php'">Tambah</button>
            ...
            function deleteUser(id) {
                console.log('Deleting user with ID:', id); // Debugging: Log the ID being deleted
            ...
            <tr class="text-center">
                ...
                <td>
                    <button onclick="window.location.href='edituser.php?id=${report.id}'" class="btn btn-primary btn-sm" title="Edit">
                        <i class="bi bi-pen"></i>
                    </button>
                    <button onclick="deleteUser(${report.id})" class="btn btn-danger btn-sm" title="Hapus">
                        <i class="bi bi-trash3"></i>
                    </button>
                </td>
            </tr>
