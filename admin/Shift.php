    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-body">
                        <h5 class="judul fw-semibold">Data Shift</h5>
                                    ...
                                    <table class="table table-bordered text-nowrap mb-0 align-middle table-hover">
                                        <thead class="fs-4">
                                            <tr class="text-center">
                                                ...
                                                <th class="fs-3" style="width: 90%">Shift</th>
            ...
            function deleteMuatan(id) {
                console.log('Deleting shift with ID:', id); // Debugging: Log the ID being deleted
                if (confirm('Apakah Anda yakin ingin menghapus shift ini?')) {
                    fetch('deleteShift.php', {
                            method: 'DELETE',
                            body: JSON.stringify({
                                id: id
            ...
            function renderTable(data) {
                ...
                const sortedData = data.sort((a, b) => a.shift.localeCompare(b.shift));

                const filteredData = sortedData.filter(report =>
                    report.shift.toLowerCase().includes(searchInput.value.toLowerCase())
                );
            ...
            <tr class="text-center">
                ...
                <td>${report.shift}</td>
                <td>
                    <button onclick="window.location.href='editShift.php?id=${report.id}'" class="btn btn-primary btn-sm" title="Edit">
                        <i class="bi bi-pen"></i>
                    </button>
