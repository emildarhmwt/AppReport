                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form method="post" action="production_update.php" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3">
                                            <label for="timbunan" class="form-label">
                                                Timbunan :</label>
                                        ...
                                        <div class="mb-3">
                                            <label for="jarak" class="form-label"> Jarak
                                                :</label>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    <label for="ritase" class="form-label">
                                                        Ritase 1 :</label>
                                                    <input type="number" class="form-control" id="ritase" name="ritase"
                                                        value="<?php echo htmlspecialchars($adminData['ritase']); ?>"
                                                        required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    <label for="ritase" class="form-label">
                                                        Ritase 2 :</label>
                                                    <input type="number" class="form-control" id="ritase2"
                                                        name="ritase2" placeholder="Input Data"
                                                        value="<?php echo htmlspecialchars($adminData['ritase2']); ?>"
                                                        required>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" class="form-control" id="total_ritase"
                                                        ...
                                                        required oninput="calculateTotalRitase()">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="mb-3">
