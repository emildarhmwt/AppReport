        ...
        if ($fileError === 0) {
            if ($fileSize < 5000000) { // Batasi ukuran file hingga 5MB
                ...
                if (move_uploaded_file($fileTmpName, $fileDestination)) {
                    ...
                    $query = "INSERT INTO user_report (nama, username, password, name_admin, file_admin, mime_admin) VALUES ($1, $2, $3, $4, $5, $6)";
                    $result = pg_query_params($conn, $query, [$nama, $username, $hashed_password, $fileName, $fileDestination, $fileType]);

                    if ($result) {
                        // Redirect to barcode.php
                        echo "<script>console.log('Data berhasil disimpan dan gambar diunggah.'); window.location.href='user.php';</script>";
                    } else {
