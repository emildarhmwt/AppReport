...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $query = "SELECT * FROM grup WHERE id = $id"; // Adjust the query as needed
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="grup_update.php" enctype="multipart/form-data">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control text-white" id="grup" name="grup"
                                    value="<?php echo htmlspecialchars($adminData['grup']); ?>" required>
                            </div>
