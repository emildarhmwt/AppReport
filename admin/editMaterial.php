...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $query = "SELECT * FROM material WHERE id = $id"; // Adjust the query as needed
    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-body">
                        <h5 class="judul fw-semibold">Form Edit Material Tanah</h5>
                        <form method="post" action="material_update.php" enctype="multipart/form-data">
                            <div class="mb-3">
                                <label for="nama" class="sub-judul mb-2">Material Tanah :</label>
                                <input type="text" class="form-control text-white" id="material" name="material"
                                    value="<?php echo htmlspecialchars($adminData['material']); ?>" required>
                            </div>
