...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $query = "SELECT * FROM executor WHERE id = $id"; // Adjust the query as needed
...
<body>
    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-body">
                        <h5 class="judul fw-semibold">Form Edit Executor</h5>
                        <form method="post" action="executor_update.php" enctype="multipart/form-data">
                            <div class="mb-3">
                                <label for="nama" class="sub-judul mb-2">Executor :</label>
                                <input type="text" class="form-control text-white" id="executor" name="executor"
                                    value="<?php echo htmlspecialchars($adminData['executor']); ?>" required>
                            </div>
    ...
    function goBack() {
        window.location.href = 'Executor.php';
    }
    </script>
